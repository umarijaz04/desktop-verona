...
namespace Verona
{
    public partial class Customer_Transactions : Form
    {
        ...
        private void btndel_Click(object sender, EventArgs e)
        {
            if (delid != "")
            {
                DialogResult dresult = MessageBox.Show("Are you sure you want to delete this Transaction", "Verona Tiles & Sanitary", MessageBoxButtons.OKCancel, MessageBoxIcon.Question);
                if (dresult == DialogResult.OK)
                {
                    try
                    {
                        ...
                        cmbtype_SelectedIndexChanged(this, null);
                        delid = "";
                        MessageBox.Show("Transaction Deleted Successfully", "Verona Tiles & Sanitary", MessageBoxButtons.OK, MessageBoxIcon.Information);
                    }
                    catch (Exception)
                    {
                        delid = "";
        ...
        {
            DialogResult dresult = MessageBox.Show("Press 'OK' to Print Transaction Invoice", "Verona Tiles & Sanitary", MessageBoxButtons.OKCancel, MessageBoxIcon.Question);
            if (dresult == DialogResult.OK)
            {
                try
                {
        ...
        private void btnadd_Click(object sender, EventArgs e)
        {
            if (cmbcus.Text != "" && txtprebal.Text != "" && cmbstatus.Text != "---Select Option---" && txtamt.Text != "" && txtbal.Text != "")
            {
                ...
                MessageBox.Show("Transaction Insert Successfully", "Verona Tiles & Sanitary", MessageBoxButtons.OK, MessageBoxIcon.Information);
                clear_data();
            }
        }
