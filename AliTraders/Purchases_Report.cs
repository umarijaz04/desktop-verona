...
namespace Verona
{
    public partial class Purchases_Report : Form
    {
        ...
        private void btndel_Click(object sender, EventArgs e)
        {
            if (delid != "")
            {
                DialogResult dresult = MessageBox.Show("Are you sure you want to delete this DC No", "Verona Tiles & Sanitary", MessageBoxButtons.OKCancel, MessageBoxIcon.Question);
                if (dresult == DialogResult.OK)
                {
                    ...
                    delid = "";
                    Login.con.Close();
                    MessageBox.Show("DC Deleted Successfully", "Verona Tiles & Sanitary", MessageBoxButtons.OK, MessageBoxIcon.Information);
                    btnsearch_Click(this, null);
                    }
                    catch (Exception)
                    {
                        MessageBox.Show("First Delete Purchases Return & Breakage Against This Sales Invoice", "Verona Tiles & Sanitary", MessageBoxButtons.OK, MessageBoxIcon.Error);
                    }
                }
            }
        }
