...
namespace Verona
{
    public partial class Sales_Invoices : Form
    {
        ...
        private void btndel_Click(object sender, EventArgs e)
        {
            if (delid != "")
            {
                DialogResult dresult = MessageBox.Show("Are you sure you want to delete this Invoice No", "Verona Tiles & Sanitary", MessageBoxButtons.OKCancel, MessageBoxIcon.Question);
                if (dresult == DialogResult.OK)
                {
                    try
                    {
                        ...
                        delid = "";
                        Login.con.Close();
                        MessageBox.Show("Invoice Deleted Successfully", "Verona Tiles & Sanitary", MessageBoxButtons.OK, MessageBoxIcon.Information);
                        btnsearch_Click(this, null);
                    }
                    catch (Exception)
                    {
                        MessageBox.Show("First Delete Sales Return Against This Sales Invoice", "Verona Tiles & Sanitary", MessageBoxButtons.OK, MessageBoxIcon.Error);
                    }
                }
            }
        }
