    ...
    public partial class Products : Form
    {
        ...
        private void btnadd_Click(object sender, EventArgs e)
        {
            if (rdbtn.Checked == true)
            {
                if (txtcodeadd.Text != "" && txtnameadd.Text != "" && txtsize.Text != "" && txtmtr.Text != "" && txtpieces.Text != "" && cmbfinish.Text != "---Select Option---")
                {
                    ...
                    if (dr.HasRows)
                    {
                        MessageBox.Show("This Product is Already Exist", "Verona Tiles & Sanitary", MessageBoxButtons.OK, MessageBoxIcon.Stop);
                        txtsize.Clear();
                        txtcodeadd.Clear();
                        txtcodeadd.Focus();
                        dr.Close();
                    ...
                    else
                    {
                        ...
                        MessageBox.Show("Product Inserted Successfully", "Verona Tiles & Sanitary", MessageBoxButtons.OK, MessageBoxIcon.Information);
                        rdbtn_CheckedChanged(this, null);
                    }
                    Login.con.Close();
                }
            ...
            else
            {
                if (txtcodeadd2.Text != "" && txtnameadd2.Text != "")
                {
                    ...
                    {
                        dr.Close();
                        SqlCommand cmd2 = new SqlCommand("INSERT into product2 (p_id,p_name) values('" + txtcodeadd2.Text.ToUpper() + "','" + txtnameadd2.Text.ToUpper() + "')", Login.con);
                        cmd2.ExecuteNonQuery();
                        MessageBox.Show("Product Inserted Successfully", "Verona Tiles & Sanitary", MessageBoxButtons.OK, MessageBoxIcon.Information);
                ...
                if (txtcodeupdate.Text != "" && txtnameupdate.Text != "" && txtsize2.Text != "" && txtmtr2.Text != "" && txtpieces2.Text != "")
                {
                    ...
                    if (flag)
                    {
                        ...
                        try
                        {
                            ...
                            cmd2.ExecuteNonQuery();
                            MessageBox.Show("Product Updated Successfully", "Verona Tiles & Sanitary", MessageBoxButtons.OK, MessageBoxIcon.Information);
                            rdbtnup_CheckedChanged(this, null);
                        }
                        catch (Exception)
                        {
                            MessageBox.Show("This Product is Already Used in Purchases Stock", "Verona Tiles & Sanitary", MessageBoxButtons.OK, MessageBoxIcon.Stop);
                        }
                    }
                    Login.con.Close();
                }
            ...
            else
            {
                if (txtcodeupdate2.Text != "" && txtnameupdate2.Text != "")
                {
                    ...
                    if (flag)
                    {
                        ...
                        try
                        {
                            SqlCommand cmd2 = new SqlCommand("UPDATE product2 set  p_name= '" + txtnameupdate2.Text.ToUpper() + "' where p_id='" + txtcodeupdate2.Text.ToUpper() + "'", Login.con);
                            cmd2.ExecuteNonQuery();
                            MessageBox.Show("Product Updated Successfully", "Verona Tiles & Sanitary", MessageBoxButtons.OK, MessageBoxIcon.Information);
        ...
        private void btndel_Click(object sender, EventArgs e)
        {
            if (rdbtnview.Checked == true)
            {
                if (delid != "")
                {
                    DialogResult dresult = MessageBox.Show("Are you sure you want to delete this Product", "Verona Tiles & Sanitary", MessageBoxButtons.OKCancel, MessageBoxIcon.Question);
                    if (dresult == DialogResult.OK)
                    {
                        try
                        {
                            ...
                            rdbtnview_CheckedChanged(this, null);
                            delid = "";
                            MessageBox.Show("Product Deleted Successfully", "Verona Tiles & Sanitary", MessageBoxButtons.OK, MessageBoxIcon.Information);
                        }
                        catch (Exception)
                        {
                            MessageBox.Show("This Product is Already Used in Purchases Stock", "Verona Tiles & Sanitary", MessageBoxButtons.OK, MessageBoxIcon.Stop);
