    ...
    public partial class Manufacturer : Form
    {
        ...
        private void btnadd_Click(object sender, EventArgs e)
        {
            if (txtcodeadd.Text != "" && txtnameadd.Text != "")
            {
                ...
                if (dr.HasRows)
                {
                    MessageBox.Show("This Manufacturer Name Already Exist", "Verona Tiles & Sanitary", MessageBoxButtons.OK, MessageBoxIcon.Stop);
                    txtnameadd.Clear();
                    txtnameadd.Focus();
                    dr.Close();
                    Login.con.Close();
                ...
                else
                {
                    ...
                    MessageBox.Show("Manufacturer Inserted Successfully", "Verona Tiles & Sanitary", MessageBoxButtons.OK, MessageBoxIcon.Information);
                    Login.con.Close();
                    addToolStripMenuItem_Click(this, null);
                }
            }
            ...
            if (txtcodeup.Text != "" && txtnameup.Text != "")
            {
                ...
                if (dr.HasRows)
                {
                    while (dr.Read())
                    {
                        if ((txtnameup.Text.ToUpper() == Convert.ToString(dr[0])))
                        {
                            flag = false;
                            dr.Close();
                            MessageBox.Show("This Manufacturer is Already Exist", "Verona Tiles & Sanitary", MessageBoxButtons.OK, MessageBoxIcon.Stop);
                            break;
                        }
                    }
                }
                if (flag)
                {
                    ...
                    try
                    {
                        ...
                        cmd2.ExecuteNonQuery();
                        MessageBox.Show("Manufacturer Updated Successfully", "Verona Tiles & Sanitary", MessageBoxButtons.OK, MessageBoxIcon.Information);
                        updateToolStripMenuItem_Click(this, null);
                    }
                    catch (Exception)
                    {
                        MessageBox.Show("This Manufacturer is Already Used in Transaction", "Verona Tiles & Sanitary", MessageBoxButtons.OK, MessageBoxIcon.Stop);
                    }
                }
                Login.con.Close();
            }
        ...
        private void btndel_Click(object sender, EventArgs e)
        {
            if (delid != "")
            {
                DialogResult dresult = MessageBox.Show("Are you sure you want to delete this Manufacturer", "Verona Tiles & Sanitary", MessageBoxButtons.OKCancel, MessageBoxIcon.Question);
                if (dresult == DialogResult.OK)
                {
                    try
                    {
                        ...
                        delid = "";
                        MessageBox.Show("Manufacturer Deleted Successfully", "Verona Tiles & Sanitary", MessageBoxButtons.OK, MessageBoxIcon.Information);
                    }
                    catch (Exception)
                    {
                        MessageBox.Show("This Manufacturer is Already Used in Transaction", "Verona Tiles & Sanitary", MessageBoxButtons.OK, MessageBoxIcon.Stop);
