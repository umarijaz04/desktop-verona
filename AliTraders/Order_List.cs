...
namespace Verona
{
    public partial class Order_List : Form
    {
            ...
            if (ckbx.Checked == true)
            {
                if (lbname.Text != "" && cmbtone.Text != "" && cmbsize.Text != "" && cmbquality.Text != "" && (txtqty.Text != "0" || txttiles.Text != "0"))
                {
                    ...
                    if (dr.HasRows)
                    {
                        ...
                        if (dr2.HasRows)
                        {
                            MessageBox.Show("This Product Already Exist in Gate Pass Cart", "Verona Tiles & Sanitary", MessageBoxButtons.OK, MessageBoxIcon.Stop);
                        }
                        else
                        {
                            dr2.Close();
        ...
        private void txtmeter_KeyDown(object sender, KeyEventArgs e)
        {
            if (e.KeyCode == Keys.Enter)
            {
                if (cmbcode.Text != "" && cmbsize.Text !="")
                {
                    ...
                    MessageBox.Show("Please Enter Code First", "Verona Tiles & Sanitary", MessageBoxButtons.OK, MessageBoxIcon.Stop);
            }
        }
        ...
        private void btndel_Click(object sender, EventArgs e)
        {
            if (delid != "")
            {
                DialogResult dresult = MessageBox.Show("Are you sure you want to delete this Gate Pass", "Verona Tiles & Sanitary", MessageBoxButtons.OKCancel, MessageBoxIcon.Question);
                if (dresult == DialogResult.OK)
                {
                    Login.con.Open();
                    ...
                    delid = "";
                    Login.con.Close();
                    MessageBox.Show("Gate Pass Deleted Successfully", "Verona Tiles & Sanitary", MessageBoxButtons.OK, MessageBoxIcon.Information);
