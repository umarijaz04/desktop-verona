...
namespace Verona
{
    public partial class Profit_Report : Form
    {
        ...
        private void btnsearch_Click(object sender, EventArgs e)
        {
            ...
            dr10.Close();
            SqlCommand cmd2 = new SqlCommand("IF EXISTS(select * FROM sys.views where name = 'purchases') DROP VIEW purchases", Login.con);
            cmd2.ExecuteNonQuery();
            SqlCommand cmd4 = new SqlCommand("IF EXISTS(select * FROM sys.views where name = 'purchases_temp') DROP view purchases_temp", Login.con);
            cmd4.ExecuteNonQuery();
            SqlCommand cmd7 = new SqlCommand("IF EXISTS(select * FROM sys.views where name = 'sales') DROP view sales", Login.con);
            cmd7.ExecuteNonQuery();
            SqlCommand cmd9 = new SqlCommand("IF EXISTS(select * FROM sys.views where name = 'sales_return') DROP view sales_return", Login.con);
            cmd9.ExecuteNonQuery();
            SqlCommand cmd100 = new SqlCommand("IF EXISTS(select * FROM sys.views where name = 'profit') DROP view profit", Login.con);
