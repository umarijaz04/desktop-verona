    ...
    public partial class Office_Expenses : Form
    {
        ...
        private void btnadd_Click(object sender, EventArgs e)
        {
            if (txtdes.Text != "" && txtamt.Text != "")
            {
                ...
                Login.con.Close();
                MessageBox.Show("Expenses Insert Successfully", "Verona Tiles & Sanitary", MessageBoxButtons.OK, MessageBoxIcon.Information);
        ...
        private void btndel_Click(object sender, EventArgs e)
        {
            if (delid != "")
            {
                DialogResult dresult = MessageBox.Show("Are you sure you want to delete this Expense", "Verona Tiles & Sanitary", MessageBoxButtons.OKCancel, MessageBoxIcon.Question);
                if (dresult == DialogResult.OK)
                {
                    ...
                    delid = "";
                    MessageBox.Show("Expense Deleted Successfully", "Verona Tiles & Sanitary", MessageBoxButtons.OK, MessageBoxIcon.Information);
                    Login.con.Close();
                }
            }
        }
