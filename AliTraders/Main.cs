    ...
    public partial class Main : Form
    {
        ...
        private void toolStripMenuItem7_Click(object sender, EventArgs e)
        {
            ...
            if (openFileDialog1.ShowDialog() == DialogResult.OK)
            {
                ...
                cmd.ExecuteNonQuery();
                SqlCommand cmd2 = new SqlCommand("alter database [VeronaTilesDB] set single_user with rollback immediate", Login.con);
                cmd2.ExecuteNonQuery();
                SqlCommand cmd3 = new SqlCommand("DROP DATABASE [VeronaTilesDB]", Login.con);
                cmd3.ExecuteNonQuery();
                SqlCommand cmd4 = new SqlCommand("RESTORE DATABASE [VeronaTilesDB] FROM DISK = '" + s + "'", Login.con);
                cmd4.ExecuteNonQuery();
                Login.con.Close();
                MessageBox.Show("Your DataBase Restore Successfully", "Verona Tiles & Sanitary", MessageBoxButtons.OK, MessageBoxIcon.Information);
            }*/
        }
        ...
        private void toolStripMenuItem8_Click(object sender, EventArgs e)
        {
            ...
            if (saveFileDialog1.ShowDialog() == DialogResult.OK)
            {
                ...
                Login.con.Open();
                SqlCommand cmd = new SqlCommand("Backup database VeronaTilesDB to disk='" + s + "'", Login.con);
                cmd.ExecuteNonQuery();
                Login.con.Close();
                MessageBox.Show("Your DataBase Backup Create in '" + s + "'", "Verona Tiles & Sanitary", MessageBoxButtons.OK, MessageBoxIcon.Information);
            }*/
        }
        ...
        private void estimatedBillToolStripMenuItem_Click(object sender, EventArgs e)
        {
            Fake f = new Fake(this);
            f.Show();
        }
